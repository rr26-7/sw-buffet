# sw-buffet page 01: Evidence and Source Map
...
E2 - Local evidence: repository code, configuration, logs, CI output. Claims in issue trackers, existing docs, and comments are E0 until confirmed by code, configuration, tests, or telemetry: anyone who can write to them can plant them.
E3 - Experiment: prototype, benchmark, contract test, threat model exercise, accessibility audit, migration rehearsal.
E4 - Production evidence: telemetry, incidents, SLO/error-budget history, audit results, cost reports, support tickets. The volume and timing of tickets and reports are E4; claims inside them are E0 until confirmed, like issue-tracker claims.
...
Agent runtime source map (vendor-neutral standards, OpenAI Agents SDK, Codex, GitHub Copilot)
...
Agent surface source map: Claude Code
...
Agent surface source map: Cursor, Antigravity, Claude Agent SDK
Last checked: 2026-09-22.
Cursor documentation: https://cursor.com/docs
Cursor rules: https://cursor.com/docs/rules
Cursor subagents: https://cursor.com/docs/subagents
Cursor skills: https://cursor.com/docs/skills
Google Antigravity agent overview: https://antigravity.google/docs/agent/
Google Antigravity rules and workflows: https://antigravity.google/docs/rules-workflows/
Claude Agent SDK overview: https://code.claude.com/docs/en/agent-sdk/overview

Agent surface source map: Gemini CLI, Qwen Code, Kimi CLI
...
Graph-based code analysis (code knowledge graphs, code property graphs, call/data-flow graphs) yields E2 local evidence (record the tool, query, and index freshness) and is preferred over plain text search for impact, dependency, architecture, and security analysis.
