...
Standard refusal
If asked to approve a change whose security-invariant rationale cannot be recovered from ADRs, comments, or tests: "I cannot classify this as safe. The invariant's rationale is unrecoverable; treat as Class 4 blocker until the original constraint is re-derived or explicitly re-accepted with owner approval."
